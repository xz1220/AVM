...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/runtime-Codex%20%7C%20Claude%20Code%20%7C%20OpenClaw%20%7C%20%E7%88%B1%E9%A9%AC%E4%BB%95%20Agent-1d4ed8" alt="目标 Runtime">
...
Agent VM，简称 `avm`，是一个面向 AI Coding Agent 的本地控制平面。它把 Agent 的角色、工具、权限、模型偏好和 memory refs 放进一个可迁移 Profile，再通过 adapter 渲染到 Codex、Claude Code、OpenClaw、爱马仕 Agent 等 runtime。
...
| 2 | Runtime Coverage | Codex、Claude Code、OpenClaw、爱马仕 Agent adapters |
...
- Codex、Claude Code、OpenClaw、爱马仕 Agent、GitHub Copilot custom agents 的 runtime mapping 调研
- adapter fixtures
- CLI 行为测试
- 解释真实工作流的文档
